...
var basicCode = function() {
     ...
     *
     * basicCode.helper('content-filter');
     *
     */
     ...
     *
     * basicCode.helper('magnific-popup');
     *
     */
     ...
     *
     * basicCode.helper('masked-inputs');
     *
     */
     ...
     *
     * basicCode.helper('draggable-items');
     *
     */
     ...
     *
     * basicCode.helper('easy-pie-chart');
     *
     */
        ...
        helpers: function(helpers) {
            if (helpers instanceof Array) {
                for (var index in helpers) {
                    basicCode.helper(helpers[index]);
                }
            } else {
                basicCode.helper(helpers);
            }
        }
    };
}();
