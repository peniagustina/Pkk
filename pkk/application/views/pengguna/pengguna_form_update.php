...
<div class="row">
    <div class="col-md-12">
        <div class="box box-success box-solid">
            <div class="box-header">
                <h4><b><i class="fa fa-tasks"></i> <?= $button ?> Data Password Pengguna</b></h4>
            </div>
            <div class="box-body">
                <form style="padding: 15px;" action="<?= $action2; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="password_ulang" id="password_ulang" placeholder="Masukkan Ulang Password" onkeyup="checkPass(); return false;" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-2">
                                <input type="hidden" name="id_pengguna" value="<?= $id_pengguna; ?>" />
                                <button type="submit" class="btn btn-primary" id="btnSimpan" disabled><i class="fa fa-floppy-o"></i> <?= $button ?> Password</button>
                            </div>
                        </div>
                    </div>
                </form>
